...
<head>
  ...
  <title> Projet Memory-Niveau Facile </title>
  <link rel="stylesheet" type="text/css" href="../css/niveau_facile.css"/>
</head>
<body>
    <section id="first">
        <div id="timer">Temps : 02:00</div>
        <button id="start" data-diff="1"> Début </button>
